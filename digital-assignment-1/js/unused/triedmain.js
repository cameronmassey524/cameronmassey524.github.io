...
function preload() {
    ...
    this.load.spritesheet('player_handgun', '../digital-assignment-1/assets/sprites/player_handgun.png',
        { frameWidth: 66, frameHeight: 60 }
    ); // Made by tokkatrain: https://tokkatrain.itch.io/top-down-basic-set
    this.load.image('bullet', '../digital-assignment-1/assets/sprites/bullets/bullet6.png');
    this.load.image('target', '../digital-assignment-1/assets/demoscene/ball.png');
    this.load.image('background', '../digital-assignment-1/assets/skies/underwater1.png');
}
